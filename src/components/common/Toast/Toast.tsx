...
function Toast({ message, title }: { message: string; title: string }) {
  return (
    <div
    ...
    >
      <div className="flex justify-between items-center py-2 px-3 bg-clip-padding border-b bg-green-600 rounded-t-lg">
